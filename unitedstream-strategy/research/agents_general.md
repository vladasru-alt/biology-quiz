...
*Выборочная проверка координатором (24.09.2026, прямое чтение страницы): цифры «около 60% валютных переводов бизнеса через посредников в апреле 2026», «Китай 59%, Турция 15%, Гонконг 11%», «комиссии до 2% и ниже» дословно есть в [Клерке, 05.05.2026](https://www.klerk.ru/buh/news/690266/). Первоисточник — данные Точки, поэтому это одна оценка, которую пересказали два СМИ, а не два независимых измерения.*
